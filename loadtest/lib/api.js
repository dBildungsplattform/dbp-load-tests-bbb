...
const getSecret = (options) => options.secret || config.api.secret || process.env.BIGBLUEBOT_SECRET;

const getMeetingID = (options) => options.room || config.url.meeting.name || process.env.BIGBLUEBOT_ROOM;
